...
<div class="r content" id="user_content">
	<div class="topNav"><?php echo yii::t('app','流水管理')?>&nbsp;&gt;&gt;&nbsp;<a href="#"><?php echo yii::t('app','線上流水')?></a></div>
	<?php
...
window.onload = function(){
	...
	$("#export").on("click",function(){
		...
		$.ajax({
            ...
            type:'get',
            data:'start_time='+start_time+'&end_time='+end_time+'&movie_id='+movie_id+'&room_id='+room_id,
            dataType:'json',
            async:false
		}).done(function(data){
		    var $a = $("<a>");
