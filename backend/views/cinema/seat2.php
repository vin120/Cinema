<?php
	...
	use backend\views\myasset\Seat2Asset;
	use yii\helpers\Url;
...
<div class="r content" id="user_content">
	...
	<div id="mainContent_content" class="pBox" style="height: 750px">
        ...
        var sc = $('#seat-map').seatCharts({
            ...
            click: function () { //点击事件
                if (this.status() == 'available') { //可选座
                    $('<li>'+(rowArray[this.settings.row])+'行'+this.settings.label+'座</li>')
                    ...
                    return 'unavailable';
                } else if (this.status() == 'forbidden') { //已售出
