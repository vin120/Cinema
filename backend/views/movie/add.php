...
<div class="r content" id="refundReason_content">
	<div class="topNav"><?php echo yii::t('app','影院管理')?>&nbsp;&gt;&gt;&nbsp;
		<a href="<?php echo Url::toRoute(['index']);?>"><?php echo yii::t('app','電影配置')?></a>
			&nbsp;&gt;&gt;&nbsp;<a href="#"><?php echo yii::t('app','添加電影')?></a></div>
		...
		<div class="searchResult">
			...
			<p>
				<label>
					...
					<input type="text" name="on_time" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd ',lang:'en'})" class="Wdate" id="on_time"></input>
				</label>
			</p>
			...
			<p>
				...
				<input type="text" name="charactor"  />
			</p>
