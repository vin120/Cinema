...
<!-- content start -->
<div class="r content">
	<div class="topNav">訂單管理&nbsp;&gt;&gt;&nbsp;<a href="#">線下訂單信息</a></div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?php echo Url::toRoute(['offorder/detail','id'=>$value['id']]);?>"><img src="<?php echo $baseUrl; ?>images/text.png"></a>
						<?php endif;?>
					</td>
				</tr>
				<?php endforeach;?>
	            		...
	            		if(data != 0){
	    	                $.each(data,function(key){
								...
								if(data[key]['status']==1) {
									str += '<a href="<?php echo Url::toRoute(['offorder/detail']);?>?id='+data[key]['id']+'"><img src="<?php echo $baseUrl; ?>images/text.png"></a>';
								}
								str += '</td>';
								str += '</tr>';
